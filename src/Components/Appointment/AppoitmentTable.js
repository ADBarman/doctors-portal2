...
const AppointmentTable = () => {
    ...
    const  makeBooking = (event) => {
        ...
        const patientData = {name : "Molla Salt" , phone : "01699999999" , email : "test@gmail.com" }
        ...
        fetch("https://doctor-portal-backend.herokuapp.com/makeBooking",{
            method : "POST",
            headers : {
    ...
    const modalController = (apId) => {
        setModalIsOpen(true);
        console.log("Click for appointment ", apId);
